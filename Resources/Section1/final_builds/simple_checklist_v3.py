...
#Icon Freeware
import tkinter
from tkinter import VERTICAL, END, ANCHOR
...
def remove_item():
    '''Remove the selceted (ANCHOR) item from the listbox'''
...
list_add_button = tkinter.Button(input_frame, text="Add Item", borderwidth=1, font=my_font, bg=button_color, command=add_item)
list_entry.grid(row=0, column=0, padx=5, pady=5)
list_add_button.grid(row=0, column=1, padx=5, pady=5, ipadx=5)

#List Frame Layout
#Make main listbox with scrollbar to hold all to do lists
...
#Option Frame Layout
list_remove_button = tkinter.Button(button_frame, text="Remove Item", borderwidth=1, font=my_font, bg=button_color, command=remove_item)
list_clear_button = tkinter.Button(button_frame, text="Clear List", borderwidth=1, font=my_font, bg=button_color, command=clear_list)
save_button = tkinter.Button(button_frame, text="Save List", borderwidth=1, font=my_font, bg=button_color, command=save_list)
quit_button = tkinter.Button(button_frame, text="Quit", borderwidth=1, font=my_font, bg=button_color, command=root.destroy)
...
#Open the previous list if availiable
open_list()
